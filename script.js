window.addEventListener("DOMContentLoaded", function () {
    let = bags = document.querySelector('.bag'),
     ...
     let cart = document.createElement("div"),
        ...
        close = document.createElement("button"); // создали корзину

        
    cart.classList.add("carts"); //присвоили классы
    ...
    openCon.addEventListener("click", function () {
        ...
        fieldCon.style.background = "rgba(0, 0, 0,.9)";
    })
    openCon.addEventListener("input", function () {
        fieldCon.style.background = "rgba(0, 0, 0,.9)";
        
    })
    function set () {
        fieldCon.style.display = "block";
        fieldCon.style.background = "rgba(0, 0, 0, 0)";
    ...
    fieldCon.addEventListener("input", function () {
        fieldCon.style.background = "rgba(0, 0, 0,.9)"
    })
